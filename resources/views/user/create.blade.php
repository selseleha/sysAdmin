    ...
    <div class="container">
        ...
        <form  method="post" action="{{route('add.store')}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="last_name" class="form-control" id="username" value="{{old('last_name')}}" >
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-lg-3" >
                        ...
                        <input  type="number"  class="form-control input-lg" name="year" value="{{old('year')}}" min="1320" max="1400" placeholder="1340" >
                    </div>
