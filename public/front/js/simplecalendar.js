var calendar = {
    init: function() {
        function t() {
            $(".remove").click(function() {
                if (this.checked) {
                    ...
                    $('.day[data-month="' + t + '"][data-day="' + a + '"][data-number="' + e + '"]').slideUp("slow"), $('.day-event[data-month="' + t + '"][data-day="' + a + '"][data-number="' + e + '"]').find(".save").data("checked", !1), $('.day-event[data-month="' + t + '"][data-day="' + a + '"][data-number="' + e + '"]').find("span").text("Save to personal list"), setTimeout(function() { $('.day[data-month="' + t + '"][data-day="' + a + '"][data-number="' + e + '"]').remove() }, 1500)
                }
            })
        }
        ...
        }), $(".close").on("click", function(t) { $(this).parent().slideUp("fast") }), $(".save").click(function() {
            if (this.checked) {
                $(this).next().text("Remove from personal list");
                ...
                var d = $(this).closest(".day-event").data("month"),
                    n = $(this).closest(".day-event").data("day"),
                    s = $(this).closest(".day-event").data("number");
                $('.day[data-month="' + d + '"][data-day="' + n + '"][data-number="' + s + '"]').slideUp("slow"), setTimeout(function() { $('.day[data-month="' + d + '"][data-day="' + n + '"][data-number="' + s + '"]').remove() }, 1500)
            }
